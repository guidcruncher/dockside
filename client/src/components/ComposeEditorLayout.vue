...
const emit = defineEmits<{
  ...
  (e: "update:proxy", value: ProxyConfig): void
}>()

const proxy = ref<ProxyConfig>(jsonClone(props.proxy))
...
function updateProxy(payload: any) {
  lastPatch.value = payload
  proxy.value.config = payload.patch.config
