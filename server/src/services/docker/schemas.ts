...
export const SystemInfoSchema = Type.Object({
  ...
  MemoryLimit: Type.Optional(Type.Boolean()),
  SwapLimit: Type.Optional(Type.Boolean()),
  KernelMemory: Type.Optional(Type.Boolean()),
  CpuCfsPeriod: Type.Optional(Type.Boolean()),
  CpuCfsQuota: Type.Optional(Type.Boolean()),
  CPUShares: Type.Optional(Type.Boolean()),
  CPUSet: Type.Optional(Type.Boolean()),
  IPv4Forwarding: Type.Optional(Type.Boolean()),
  BridgeNfIptables: Type.Optional(Type.Boolean()),
  BridgeNfIp6tables: Type.Optional(Type.Boolean()),
  Debug: Type.Optional(Type.Boolean()),
  NFd: Type.Number(),
  OomKillDisable: Type.Optional(Type.Boolean()),
